...
class AegisTeamBuilder:
    ...
    MEGA_PROBABILITIES = {
        "ライチュウ": 0.9, "ガブリアス": 0.1, "ラグラージ": 0.5,
        "リザードン": 0.9, "メタグロス": 0.9, "バシャーモ": 0.7, "ギャラドス": 0.5,
        "カイリュー": 0.66, "キラフロル": 0.5, "クチート": 0.9, "ゲンガー": 0.7,
        "ドラミドロ": 0.9, "ハッサム": 0.8, "ミミロップ": 0.9, "メガニウム": 0.9,
        "マフォクシー": 0.9, "ゲッコウガ": 0.5, "スターミー": 0.9, "フラエッテ(えいえん)": 0.9,
        "フシギバナ": 0.9, "ルカリオ": 0.9, "ウツボット": 0.8, "シャンデラ": 0.66,
        "カメックス": 0.9, "バンギラス": 0.5, "ブリガロン": 0.66, "ガルーラ": 0.9,
        "ヤドラン": 0.5, "ピクシー": 0.7, "ユキメノコ": 0.85, "シビルドン": 0.8,
        "ドリュウズ": 0.33, "サーナイト": 0.6, "ヤミラミ": 0.66, "スコヴィラン": 0.6,
        "カエンジシ": 0.66, "ペンドラー": 0.5, "ガメノデス": 0.75, "ジュカイン": 0.8,
        "エアームド": 0.5, "エルレイド": 0.4, "ズルズキン": 0.8, "ユキノオー": 0.5,
        "ジュペッタ": 0.7, "ムクホーク": 0.85
    }
